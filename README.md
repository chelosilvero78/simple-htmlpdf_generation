...
This is a code inspired by [article](https://medium.freecodecamp.org/how-to-generate-dynamic-pdfs-using-react-and-nodejs-eac9e9cb4dde).
...
Second one: go into the server directory and ```run node index.js```
